...
namespace Pharmacy.linq
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="ClientDictionary")]
    ...
    partial void DeleteSiteConnection(SiteConnection instance);
		...
		[Function(Name="dbo.GetSiteSummaryDistinct")]
    ...
    partial void OnConnVendor_idChanged();
		...
		[Column(Storage="_connection_id", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		...
		[Column(Storage="_connection_string", DbType="NVarChar(1000) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_ConnVendor_id", DbType="Int NOT NULL")]
		...
		[Association(Name="Connection_SiteConnection", Storage="_SiteConnections", ThisKey="connection_id", OtherKey="Connection_id")]
	...
	[Table(Name="dbo.SiteConnections")]
    ...
    partial void OnConnType_idChanged();
		...
		[Column(Storage="_SiteCode", DbType="NVarChar(50) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		...
		[Column(Storage="_Connection_DBVersion", DbType="Int NOT NULL", IsPrimaryKey=true)]
		...
		[Column(Storage="_Connection_id", DbType="Int NOT NULL")]
		public int Connection_id
		{
			get
			{
		...
		[Column(Storage="_ConnType_id", DbType="Int NOT NULL", IsPrimaryKey=true)]
		...
		[Association(Name="Connection_SiteConnection", Storage="_Connection", ThisKey="Connection_id", OtherKey="connection_id", IsForeignKey=true)]
