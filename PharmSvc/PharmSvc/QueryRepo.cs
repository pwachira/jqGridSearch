...
namespace Pharmacy
{
    public static class QueryRepo
    {
        ...
        internal static IQueryable<Order> qryableArchOrders(ArchiveClassesDataContext archdc, DateTime Start, DateTime End)
        {
            return archdc.DtsRdeOrdersStdArchives.Where(o => o.DtsRdeStdArchive.messageDateTime <= End.AddDays(1)
                                                      ...
                                                      .Select(o1 => new Order
                                                      {
                                                          ...
                                                          OrcStartTime = (Nullable<DateTime>)o1.quantityTiming_StartTime,
                                                          TransactionDate = (Nullable<DateTime>)o1.transactionDate,
                                                          DataSource = o1.DtsRdeStdArchive.datasource
        ...
        internal static IQueryable<Component> qryableComponents(ArchiveClassesDataContext adc, int HdrTk, DateTime Start, DateTime End)
        {
            var cpnts = adc.DtsRdeOrdersRxcStdArchives
                ...
                .Select(c2 => new Component
                {
                    ...
                    RxeDrugCode = c2.DtsRdeOrdersStdArchive.rxe_GiveCode_Identifier,
                    ...
                    ComponentStrengthUnits = c2.RDE_Orders_RXC_ComponentStrengthUnitsIdentifier,
        ...
        { 
            return from sdr in ddc.CSS_SiteDrugRoutes
                    select new SiteDrugRoute
                    {
                        Id = (int)sdr.PharmacyDrugId,
                        MappedPharmacyDrug = sdr.CSS_SiteDrug.MappedPharmacyDrug,
        ...
        internal static IQueryable<Component> qryableRxcDistinct(ArchiveClassesDataContext adc, IQueryable<Component> components)
        {
            ...
            return components.GroupBy(c => new {  c.ComponentCodeText,c.ComponentCodeId, c.ComponentType,  c.OrderRxcRowTk, c.RxeDrugName,c.RxeDrugCode }
                 , (c2, g) => new Component
                 {
                     RxeDrugName = c2.RxeDrugName,
                     RxeDrugCode=c2.RxeDrugCode,
                     OrderRxcRowTk = c2.OrderRxcRowTk,
                     ComponentCodeText = c2.ComponentCodeText,
                     ComponentCodeId = c2.ComponentCodeId,
        ...
        //    PharmacyClass = p.CSS_PharmacyClassCombos.
        //    });
            
            
        //}
        internal static IQueryable<PharmacyDrugWithClass> PharmDrugsWithClass( CssPharmDataContext dc)
        {
            return  dc.CSS_PharmacyClassCombos.Select(cc => new PharmacyDrugWithClass
            {
                Id = cc.CSS_PharmacyDrug.PharmacyDrugId,
                MappedPharmacyDrug = cc.CSS_PharmacyDrug.MappedPharmacyDrug,
                MappedPharmacyRoute = cc.CSS_PharmacyDrug.MappedPharmacyRoute,
                MappedPharmacyUnit = cc.CSS_PharmacyDrug.MappedPharmacyUnit,
                PharmacyClassName = cc.CSS_PharmacyClass.PharmacyClassName,
                PharmacyDrugProperties = cc.CSS_PharmacyDrug.PharmacyDrugProperties,
                TreatmentProfileId = cc.CSS_PharmacyDrug.TreatmentProfileId,
                TreatmentProfileName = cc.CSS_PharmacyDrug.CSS_TreatmentProfile.TreatmentProfileName
            });

        }

        internal static IQueryable<PharmacyDrug> PharmacyDrugs(IQueryable<PharmacyDrugWithClass> o, string sidx, string sord)
        {
            return o.Select( pdc => new PharmacyDrug { 
                Id = pdc.Id,
                MappedPharmacyDrug = pdc.MappedPharmacyDrug,
                MappedPharmacyRoute = pdc.MappedPharmacyRoute,
                MappedPharmacyUnit = pdc.MappedPharmacyUnit,
                PharmacyDrugProperties = pdc.PharmacyDrugProperties,
                TreatmentProfileId = pdc.TreatmentProfileId,
                TreatmentProfileName = pdc.TreatmentProfileName
            }).Distinct().OrderBy<PharmacyDrug>(sidx,sord);
        }

        internal static IQueryable<SiteDrug> NewDmssOrders(DmssClassesDataContext ddc, DateTime Start, DateTime End)
        {
