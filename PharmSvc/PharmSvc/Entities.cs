...
namespace Pharmacy
{
    ...
    public class Order : OrderBase
    {
        ...
        public Nullable<DateTime> OrcStartTime { get; set; }
    ...
    public class Component
    {
        ...
        public string RxeDrugCode { get; set; }
        public int Count { get; set; }
    }


    public class PharmacyDrugWithClass
    {
        public int Id { get; set; }
        public string MappedPharmacyDrug { get; set; }
    ...
    public class SiteDrugRoute
    {
        ...
        public string SiteDrugName { get; set; }
        public string MappedPharmacyDrug { get; set; }
        public  string TreatmentProfile { get; set; }
